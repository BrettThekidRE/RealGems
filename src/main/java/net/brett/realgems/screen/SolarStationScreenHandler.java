...
import net.minecraft.screen.slot.Slot;
    ...
    public class SolarStationScreenHandler extends ScreenHandler {

        private final Inventory inventory;
        private final PropertyDelegate propertyDelegate;
        public final SolarStationBlockEntity blockEntity;


        protected SolarStationScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
